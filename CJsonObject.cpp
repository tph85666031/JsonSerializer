...
std::string CJsonObject::operator()(const std::string& strKey) const
{
    ...
    else if(pJsonStruct->type == cJSON_Int)
    {
        ...
        {
            if(pJsonStruct->valueint <= (int64_t)INT_MAX && (int64_t)pJsonStruct->valueint >= (int64_t)INT_MIN)
            {
                snprintf(szNumber, sizeof(szNumber), "%d", (int32_t)pJsonStruct->valueint);
            }
            else
            {
                snprintf(szNumber, sizeof(szNumber), "%lld", (int64_t)pJsonStruct->valueint);
            }
        }
        else
        {
            if((uint64_t)pJsonStruct->valueint <= (uint64_t)UINT_MAX)
            {
...
bool CJsonObject::Get(const std::string& strKey, char* charArray) const
{
    if(charArray == NULL)
    {
        return false;
...
bool CJsonObject::Get(const std::string& strKey, const char* charArray) const
{
    return false;
}
...
bool CJsonObject::Get(const std::string& strKey, char& iValue) const
{
    int32_t value = 0;
    bool ret = Get(strKey, value);
    iValue = (char)value;
    return ret;
}

bool CJsonObject::Get(const std::string& strKey, int8_t& iValue) const
{
    int32_t value = 0;
    bool ret = Get(strKey, value);
    iValue = (int8_t)value;
...
bool CJsonObject::Get(const std::string& strKey, uint8_t& uiValue) const
{
    uint32_t value = 0;
    bool ret = Get(strKey, value);
    uiValue = (uint8_t)value;
    return ret;
}

bool CJsonObject::Get(const std::string& strKey, int16_t& iValue) const
{
    int32_t value = 0;
    bool ret = Get(strKey, value);
...
bool CJsonObject::Get(const std::string& strKey, uint16_t& uiValue) const
{
    uint32_t value = 0;
    bool ret = Get(strKey, value);
    uiValue = (uint16_t)value;
    return ret;
}

bool CJsonObject::Get(const std::string& strKey, int32_t& iValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
    ...
    {
        iValue = (int32_t)(pJsonStruct->valueint);
        return(true);
    }
    else if(pJsonStruct->type == cJSON_Double)
    {
        iValue = (int32_t)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}

bool CJsonObject::Get(const std::string& strKey, uint32_t& uiValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Get(const std::string& strKey, int64_t& llValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
    ...
    if(pJsonStruct->type == cJSON_Int)
    {
        llValue = (int64_t)(pJsonStruct->valueint);
        return(true);
    }
    else if(pJsonStruct->type == cJSON_Double)
    {
        llValue = (int64_t)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}

bool CJsonObject::Get(const std::string& strKey, uint64_t& ullValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
    ...
    if(pJsonStruct->type == cJSON_Int)
    {
        ullValue = (uint64_t)(pJsonStruct->valueint);
        return(true);
    }
    else if(pJsonStruct->type == cJSON_Double)
    {
        ullValue = (uint64_t)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}
...
bool CJsonObject::Get(const std::string& strKey, bool& bValue) const
{
    ...
    if(pJsonStruct->type == cJSON_False || pJsonStruct->type == cJSON_True)
    {
    ...
    {
        bValue = (pJsonStruct->valueint == 1);
    }
    else if(pJsonStruct->type == cJSON_String && pJsonStruct->valuestring != NULL)
    {
        if(strcasecmp(pJsonStruct->valuestring,"true")==0 || strcasecmp(pJsonStruct->valuestring,"yes")==0)
        {
            bValue = true;
        }
    }
...
bool CJsonObject::Add(const std::string& strKey, const char* charArray)
{
    if(charArray == NULL)
    {
        return false;
    }
    return Add(strKey, std::string(charArray));
}
...
{
    return Add(strKey, (int32_t)cValue);
}

bool CJsonObject::Add(const std::string& strKey, int8_t iValue)
{
    return Add(strKey, (int32_t)iValue);
}

bool CJsonObject::Add(const std::string& strKey, uint8_t uiValue)
{
    return Add(strKey, (uint32_t)uiValue);
}

bool CJsonObject::Add(const std::string& strKey, int16_t iValue)
{
    return Add(strKey, (int32_t)iValue);
}

bool CJsonObject::Add(const std::string& strKey, uint16_t uiValue)
{
    return Add(strKey, (uint32_t)uiValue);
}

bool CJsonObject::Add(const std::string& strKey, int32_t iValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_t)iValue, -1);
    if(pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, uint32_t uiValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_t)uiValue, 1);
    if(pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Add(const std::string& strKey, int64_t llValue)
{
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_t)llValue, -1);
    if(pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Replace(const std::string& strKey, int32_t iValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(const std::string& strKey, uint32_t uiValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(const std::string& strKey, int64_t llValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(const std::string& strKey, uint64_t ullValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_t)ullValue, 1);
    if(pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Replace(const std::string& strKey, const bool bValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Get(int iWhich, int32_t& iValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Get(int iWhich, uint32_t& uiValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Get(int iWhich, int64_t& llValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Get(int iWhich, uint64_t& ullValue) const
{
    cJSON* pJsonStruct = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(int32_t iValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(int64_t llValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(uint64_t ullValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(const bool bValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(int32_t iValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(int64_t llValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(uint64_t ullValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::AddAsFirst(const bool bValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData != NULL)
    {
...
bool CJsonObject::Replace(int iWhich, int32_t iValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(int iWhich, uint32_t uiValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(int iWhich, int64_t llValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
    ...
    cJSON* pJsonStruct = cJSON_CreateInt((uint64_t)((uint64_t)llValue), -1);
    if(pJsonStruct == NULL)
    {
        return(false);
    }
...
bool CJsonObject::Replace(int iWhich, uint64_t ullValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
...
bool CJsonObject::Replace(int iWhich, const bool bValue)
{
    cJSON* pFocusData = NULL;
    if(m_pJsonData == NULL)
    {
